def xor(str,key):
    """Функция возврашает зашированную страку
    str - первый аргумент, предположительно строка
    key - второй аргумент, предположительно целое число
    """
    try:
        str1 = ''
        for i in str:
...
try:
    ...
    with open('HOMERWORK6\№3\output.txt', 'w') as file:
        ...
        file.write('Deshifrovannaya stroka: {} c key: {}'
                                .format(shif_string,key))
